...
CREATE DATABASE IF NOT EXISTS `gaulois` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gaulois`;
...
-- Listage des données de la table gaulois.autoriser_boire : ~31 rows (environ)
...
-- Listage des données de la table gaulois.potion : ~0 rows (environ)
...
-- Listage des données de la table gaulois.prendre_casque : ~0 rows (environ)
...
-- Listage des données de la table gaulois.specialite : ~0 rows (environ)
...
-- Listage des données de la table gaulois.type_casque : ~0 rows (environ)
